      ...
      {isLoading ? (
        ...
        <div className="card flex flex-col items-center gap-3 px-6 py-16 text-center">
          ...
          <p className="max-w-sm text-sm text-graphite">
            Once you generate an image from a prompt, it'll show up here alongside every variation.
          </p>
            ...
            {items.map((gen) => (
              <div key={gen.id} className="card overflow-hidden">
                <div className="grid grid-cols-2 gap-px bg-panelBorder">
                  <div className="flex aspect-square items-center bg-surface p-3">
                    <p className="line-clamp-6 text-xs text-graphite">{gen.prompt}</p>
                  </div>
